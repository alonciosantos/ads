...
class AuthenticatedSessionController extends BaseController
{
    ...
    public function create()
    {
        ...
        //o usuario estva tentando compra o plano?
        //verificamos se temos algo na session
        if(session()->has('choice')){
            //sim redirecionamos para a mesma rota de compra
            return redirect()->to(session('choice'));
        }
        //Estava tentando perguntar?
        if(session()->has('details')){

            //recuperamos a rota da pergunta
            $redirectTo = session('details');
            
            //removo details da sessão
