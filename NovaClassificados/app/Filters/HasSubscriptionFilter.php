    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        if(!$request->isAJAX()){
            ...
            if(!$this->gerencianetService->userHasSubscription()){
                ...
                if(url_is('api*')){ 
                    return $this->fail('Oooops.... verficamos que voçê ainda não possui um plano', ResponseInterface::HTTP_UNAUTHORIZED);
               ...
               return redirect()->back()->with('danger','Oooops.... verficamos que voçê ainda não possui um plano. Mostrar os Planos');
            }
        }
