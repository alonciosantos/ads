            ...
            <div class="col-md-4">
                <div class="sidebar">
                    ...
                    <div class="widget user text-center">
                        ...
                        <ul class="list-inline ali mt-20 ">
                            ...
                            <li class="list-inline-item"><a href="<?php echo route_to('adverts.user', $advert->username); ?>" class="btn btn-outline-primary btn-offer">Anúncios de <?php  echo '<br>'. $advert->name ?? $advert->username; ?></a></li>
