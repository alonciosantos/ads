                ...
                <div class="product-grid-list">
                    ...
                    <div class="row">
                        <?php if (empty($adverts)) : ?>
                            <div class="col-md-12 ">
                            <div class="alert alert-info text-center">Não há anúncios para esse usúario.</div>
                            </div>
                        <?php else : ?>
                                    ...
                                    <div class="product-item bg-light">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h4 class="card-title"><a href="<?php echo route_to('adverts.detail', $advert->code) ?>"><?php echo word_limiter($advert->title,5); ?></a></h4>
