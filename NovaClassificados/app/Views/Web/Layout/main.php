...
<head>
    ...
    <link href="<?php echo site_url('web/'); ?>css/jquery-ui.css" rel="stylesheet">
    <!-- Bootstrap -->
  ...
  <![endif]-->
   ...
   <link rel="stylesheet" href="<?php echo site_url('web/auto-complete/jquery-ui.css'); ?>" />
    ...
    <style>
        ...
        .ui-menu-item .ui-item-wrapper .ui-state-active{
        ...
        /**
        *Para a imagem do auto complete
         */
                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <a class="navbar-brand" href="index.html">
                            <img src="<?php echo site_url('web/'); ?>images/logo-x.png" alt="">
                        </a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <?php if(!auth()->check()) : ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link login-button" href="<?php echo route_to('login'); ?>">Entrar</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link login-button" href="<?php echo route_to('register'); ?>">Criar Conta</a>
                                </li>
                        ...
                        <div class="short-popular-category-list text-center">
                            ...
                            <ul class="list-inline mb-2">
                                ...
                                <li class="list-inline-item">
                                    <a href="<?php echo route_to('adverts.category',$category->slug); ?>"> <?php echo $category->name;?> (<?php echo $category->total_adverts;?>)</a>
                                </li>
...
=============================-->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
                    ...
                    <div class="block about">
                        <!-- footer logo -->
                        <img src="<?php echo site_url('web/'); ?>images/logo-f.png" alt="">
                        <!-- description -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-12">
                    <!-- Copyright -->
                    <div class="copyright">
                        <p>Copyright © 2016. All Rights Reserved</p>. Downloaded from <a href="https://themeslab.org/" target="_blank">Themeslab</a>
                    </div>
                </div>
                <div class="col-sm-6 col-12">
                    <!-- Social Icons -->
    ...
    <script src="<?php echo site_url('web/toastr/toastr.min.js'); ?>"></script>
    ...
    <script>
        ...
        // .btn-gn é onde informanos a class do botao a ser clicado para disparar o evento LoaderOverlay
