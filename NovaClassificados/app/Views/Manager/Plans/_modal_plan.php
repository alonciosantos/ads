   ...
   <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
         ...
         <div class="row">
            ...
            <div class="mb-3">
               <label for="recorrence" class="form-label"><?php echo lang('Plans.label_recorrences'); ?></label>
               <!-- sera preenchido pelo javascript-->
               <span id="boxRecorrences"></span>
               <span class="text-danger error-text recorerence"></span>
            </div> 
            ...
            <div class="mb-3">
               ...
               <textarea class="form-control" name="description"  rows="5" placeholder="<?php echo lang('Plans.label_description'); ?>"></textarea>
             ...
             <div class="form-check form-switch">
               ...
               <label class="form-check-label" for="is_highlighted"><?php echo lang('Plans.label_is_highlighted'); ?></label>
              </div>
