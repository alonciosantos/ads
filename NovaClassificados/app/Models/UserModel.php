...
class UserModel extends Model implements UserProviderInterface
{
    ...
    public function fake(Generator &$faker)
    {
        ...
        return [
            ...
            'email_verified_at'     => date('Y-m-d H:i:s'), //esta verificado
    ...
    // metodo para recupera o usuario admin
    public function getSuperadmin()
    {
        // recupera o superadmin_id na tabela supersadmins comparado co users 
